...
//   anim.SetConstantPosition(wifiStaNodes.Get(0), 6.0, 7.0);
//   anim.SetConstantPosition(wifiStaNodes.Get(0), 7.0, 8.0);
//   anim.SetConstantPosition(wifiStaNodes.Get(1), 8.0, 9.0);
